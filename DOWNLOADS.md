...
```
里面有 4 个文件：`zuma.lua`（116,734）、`hello.lua`（5,141）、`manual.html`（18,541）、`README.txt`（837）
...
|---|---|---|---|
| `zuma-pc.zip` | 50,724 | 49.5 KB | `7a21e37c452434c5c6ec40a5171c4ec6023f8b1f58c598baa30c1d745ab8ef9e` |
