...
```
里面有 4 个文件：`zuma.lua`（154,732）、`hello.lua`（5,141）、`manual.html`（28,870）、`README.txt`（837）
...
|---|---|---|---|
| `zuma-pc.zip` | 68,372 | 66.8 KB | `90012213790c6504c975d65f6fa5ccf2dfe490a828e30ffcd86a8abd00c0d24a` |
| `dsh-session.zip` | 18,714,097 | 17.8 MB | `233ccbc40484ac58d891ed1798ef2a354c249fb7332e983eab3f9b850f1c51a8` |
| `zuma.lua` | 154,732 | 151.1 KB | `008e60cf1b3fae739ae30a4bb1f6e270514d19baf674459d23b02c3d89dbd728` |
