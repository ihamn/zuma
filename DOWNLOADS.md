...
```
里面有 4 个文件：`zuma.lua`（136,784）、`hello.lua`（5,141）、`manual.html`（26,826）、`README.txt`（837）
...
|---|---|---|---|
| `zuma-pc.zip` | 60,916 | 59.5 KB | `39bdb03f21e30955c09d2df6d23422145ab5dc2e32663fda0461198eeb44a111` |
| `dsh-session.zip` | 18,714,097 | 17.8 MB | `233ccbc40484ac58d891ed1798ef2a354c249fb7332e983eab3f9b850f1c51a8` |
| `zuma.lua` | 136,784 | 133.6 KB | `b26971011fb2d2dcf040c5f80ecb6334330904352bf416b88aad004021d6f94e` |
