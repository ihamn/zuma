...
```
里面有 4 个文件：`zuma.lua`（129,510）、`hello.lua`（5,141）、`manual.html`（25,705）、`README.txt`（837）
...
|---|---|---|---|
| `zuma-pc.zip` | 57,718 | 56.4 KB | `a6356d85de872b74d68f2e1cc9d6f4ddfacc260ef9469dcc0c7f5ceb29be359c` |
