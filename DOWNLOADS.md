...
```
里面有 4 个文件：`zuma.lua`（155,945）、`hello.lua`（5,141）、`manual.html`（28,870）、`README.txt`（837）
...
|---|---|---|---|
| `zuma-pc.zip` | 68,866 | 67.3 KB | `8592ea3c8472bc402886867327b84188c59d0094a403a1714bb85bbb7d7963fb` |
| `dsh-session.zip` | 18,714,097 | 17.8 MB | `233ccbc40484ac58d891ed1798ef2a354c249fb7332e983eab3f9b850f1c51a8` |
| `zuma.lua` | 155,945 | 152.3 KB | `40e32a3c662c3a7739e9b4e0ee96cbf5eb4bc82d1888addb8a0c3ab24d36cbb5` |
